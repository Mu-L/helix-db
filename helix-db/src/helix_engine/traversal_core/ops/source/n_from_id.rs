use crate::{
    helix_engine::{
        storage_core::{storage_methods::StorageMethods, HelixGraphStorage}, traversal_core::{traversal_iter::{RoArenaTraversalIterator, RoTraversalIterator}, traversal_value::TraversalValue}, types::GraphError
    },
    utils::items::Node,
};
...
impl<'a, 'env, I: Iterator<Item = Result<TraversalValue, GraphError>>> NFromIdAdapter<'a>
