...
| `embedded_write_latency` | `bench` | `crates/db/benches/embedded_write_latency.rs` | Measures embedded database write latency. |
...
| `fts_prefilter` | `bench` | `crates/db/benches/fts_prefilter.rs` | Measures text-search prefilter performance. |
