//! Downstream compile and wire contracts for canonical public encoding APIs.

#[test]
fn root_property_paths_forward_to_the_canonical_v2_codecs() {
    let root_property_hash: db::encoding::indexes::PropertyHash = [0; 4];
    let root_value_hash: db::encoding::indexes::ValueHash = [0; 8];
    let v2_property_hash: db::encoding::v2::keys::indexes::PropertyHash = root_property_hash;
    let v2_value_hash: db::encoding::v2::keys::indexes::ValueHash = root_value_hash;
