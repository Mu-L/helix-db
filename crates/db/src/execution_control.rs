...
impl ExecutionControl {
    /// Creates legacy execution control with no deadline.
    #[must_use]
    ...
    /// Returns an error once the monotonic execution deadline has elapsed.
    ...
    /// Runs cancellable pre-commit work only until the execution deadline.
    ///
