...
use crate::index_v2::outbox::{self, ClaimPermission, OperationPointerObservation};
...
pub fn index_outbox_failpoint_names() -> [&'static str; 16] {
    crate::index_v2::failpoints::IndexOutboxFailpoint::ALL.map(|failpoint| failpoint.as_str())
}
...
impl LifecycleTestController {
    ...
    pub async fn seed_empty_legacy_vector_adoption(
        ...
        let physical_index_id = crate::index_v2::VectorPhysicalIndexId::new(
        ...
        F: Fn(u64) -> Vec<Property>,
    {
        ...
        while batch_start < ids.end {
            ...
            let transaction = writer
                ...
                .await?;
            let mutations =
                crate::index_v2::secondary::load_mutation_set(&transaction, scope).await?;
            for entity_id in batch_start..batch_end {
    ...
    pub async fn advance(
        ...
        db.advance_index_v2_lifecycle_test_work(target, None).await
    }
    ...
    pub async fn advance_at_unix_millis(
        ...
        db.advance_index_v2_lifecycle_test_work(target, Some(now_unix_millis))
            .await
    }
    ...
    pub async fn discover(
        ...
        db.discover_index_v2_lifecycle_test_work(per_lane_limit)
            .await
    }
    ...
    pub async fn inspect(
        ...
        db.inspect_index_v2_lifecycle_test_work(target).await
    }
    ...
    pub async fn text_manifest_validation_lane(
        ...
        Ok(match operation.progress() {
            crate::index_v2::IndexOperationProgress::TextBuild(
            ...
            crate::index_v2::IndexOperationProgress::SecondaryBuild(_)
            | crate::index_v2::IndexOperationProgress::VectorBuild(_)
            | crate::index_v2::IndexOperationProgress::TextBuild(_)
            | crate::index_v2::IndexOperationProgress::SecondaryCleanup(_)
            | crate::index_v2::IndexOperationProgress::VectorCleanup(_)
            | crate::index_v2::IndexOperationProgress::TextCleanup(_) => None,
        })
    }
    ...
    pub async fn repage_active_text_manifest_for_testing(
        ...
        let entries =
            crate::index_v2::text::serving::load_active_manifest_page(writer, &root, 0).await?;
        if entries.len() < 2 {
            return Err(HelixDbError::IndexCatalogCorruption(format!(
    ...
    pub async fn install_donor_split_for_search_race(
        ...
        let donor_root = crate::index_v2::text::serving::load_active_manifest_root(
            donor_writer,
            &donor_authority,
        ...
        let donor_entries =
            crate::index_v2::text::serving::load_active_manifest_page(donor_writer, &donor_root, 0)
                .await?;
    ...
    pub async fn create_index(
        ...
        let writer = db.lifecycle_test_writer_db()?;
        let receipt = crate::index_v2::lifecycle::create_index_operation_from_current_source(
...
impl HelixDB {
    ...
    pub async fn open_for_index_v2_lifecycle_testing(
    ...
    /// database encoding.
    pub async fn open_with_object_store_for_index_v2_lifecycle_testing(
    ...
    async fn advance_index_v2_lifecycle_test_work(
        &self,
        target: LifecycleWorkTarget,
    ...
    async fn discover_index_v2_lifecycle_test_work(
        &self,
        per_lane_limit: NonZeroUsize,
    ) -> Result<LifecycleWorkPage> {
        if self.mode() != HelixDbMode::Writer {
    ...
    async fn inspect_index_v2_lifecycle_test_work(
        &self,
        target: LifecycleWorkTarget,
    ) -> Result<LifecycleCheckpoint> {
        if self.inner.lifecycle_test_scheduling != IndexLifecycleScheduling::ExplicitOnly {
    ...
    async fn lifecycle_test_writer_epoch(&self) -> Result<crate::index_v2::WriterEpoch> {
...
fn operation_checkpoint(record: &crate::index_v2::IndexOperationRecord) -> LifecycleCheckpoint {
