...
mod tests {
    ...
    async fn drop_rejects_canonical_key_value_identity_disagreement() {
        ...
        let mismatched = IndexRecordV2::building(
            crate::index_v2::IndexId::initial(),
            other,
            crate::index_v2::IndexRevision::initial(),
            crate::index_v2::PhysicalGeneration::Secondary {
    ...
    async fn vector_create_propagates_physical_id_exhaustion() {
        ...
        db.put(
            ...
            encode_metadata_value(&IndexV2MetadataValue::VectorPhysicalIdWatermark(
                crate::index_v2::VectorPhysicalIdWatermark {
                    next_id: crate::index_v2::VectorPhysicalIndexId::new(u64::MAX).unwrap(),
                },
            )),
        )
        .await
