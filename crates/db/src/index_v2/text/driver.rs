...
#[async_trait]
impl crate::index_v2::worker::ActiveTextCompactionDriver for TextIndexDriver {
...
fn operation_input_delta(before: &IndexOperationRecord, after: &IndexOperationRecord) -> u64 {
    let before = crate::index_v2::IndexOperationStatus::from_record(before)
        .common()
        .progress
        .input_bytes;
    let after = crate::index_v2::IndexOperationStatus::from_record(after)
        .common()
        .progress
        .input_bytes;
