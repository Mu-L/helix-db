...
mod tests {
    ...
    async fn one_scan_classifies_every_family_and_same_snapshot_active_handle() {
        ...
        assert!(matches!(
            routes.targets_for(&crate::index_v2::graph_mutation::GraphMutationTransition::create(
                scope,
                crate::index_v2::graph_mutation::GraphEntity::node(1),
                crate::index_v2::graph_mutation::CanonicalPropertyRow::new(vec![
        ...
        let vector_row = crate::index_v2::graph_mutation::CanonicalPropertyRow::new(vec![
        ...
        let crate::index_v2::graph_mutation::PropertyEditOutcome::Changed(unrelated) =
            crate::index_v2::graph_mutation::GraphMutationTransition::edit(
                scope,
                crate::index_v2::graph_mutation::GraphEntity::node(2),
                vector_row.clone(),
                crate::index_v2::graph_mutation::PropertyEdit::set(
        ...
        let crate::index_v2::graph_mutation::PropertyEditOutcome::Changed(vector_change) =
            crate::index_v2::graph_mutation::GraphMutationTransition::edit(
                scope,
                crate::index_v2::graph_mutation::GraphEntity::node(2),
                vector_row,
