    ...
    match decoder.take_u8()? {
        0x01 => {
            let digest = decoder.take_array::<{
                crate::encoding::v1::property::equality_value::EQUALITY_DIGEST_LEN
            }>()?;
            let canonical = decoder.take_bytes(MAX_LENGTH_DELIMITED_FIELD)?;
            Ok(CanonicalSecondaryValue::Equality(
                crate::encoding::v1::property::equality_value::CanonicalEqualityValue::try_from_parts(
                    digest,
                    canonical,
                )?,
            ))
        ...
        0x02 => {
            ...
            Ok(CanonicalSecondaryValue::range(
                crate::encoding::v1::property::range_value::CanonicalRangeValue::try_from_encoded(
                    direction,
