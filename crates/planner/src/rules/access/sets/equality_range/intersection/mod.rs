//! Literal equality-union restriction by same-property range intersections.
...
pub(in crate::rules::access) fn simplify_access_equality_range_intersection(
...
pub(in crate::rules) fn access_path_has_equality_range_intersection_candidate(
    access: &logical::AccessPath,
) -> bool {
    match access {
