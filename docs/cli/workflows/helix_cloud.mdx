...
`helix service-credential` to manage headless HTTP API and unified MCP credentials. MCP tool
access follows project grants; service credentials do not receive Cloud discovery or observability
tools. Neither is a CLI login method.
